...
public class TypeRacer {
    ...
    /* Kode ini merupakan method addResult() dengan parameter Typer. Method ini digunakan untuk 
    menambahkan hasil perlombaan dari typer ke dalam raceStanding. Di dalam method, terdapat sebuah
    perhitungan untuk menghitung timeResult yang didapatkan dari perkalian antara jumlah kata yang 
    diketik oleh typer dengan waktu yang dibutuhkan untuk mengetik 1 kata oleh typer. Selanjutnya, 
    method ini membuat sebuah objek Result baru dengan menyimpan nama bot dari typer dan waktu yang dibutuhkan tadi. 
    Objek Result tersebut lalu disimpan ke dalam List bernama raceStanding. Kode ini tidak mengembalikan
    nilai apa pun (void). */
